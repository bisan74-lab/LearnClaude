...
![Vercel Import 화면의 Environment Variables 섹션](/LearnClaude/images/vercel-configure.40seridxalxbg.png)

`.env.local` 파일이 있다면 **Import .env** 버튼으로 한 번에 등록할 수 있습니다.

![Vercel Import .env 버튼으로 환경 변수를 한 번에 등록하는 화면](/LearnClaude/images/vercel-env-vars.26gnn2_5c616n.png)
