...
![Claude Desktop에서 Code 탭이 선택된 화면](/LearnClaude/images/code-tab.2g2c-ybabhkxg.png)
...
![Claude Code Desktop 새 세션 입력창 주변의 확인 항목](/LearnClaude/images/new-session-controls.0ohal0awqmhrv.png)
...
![Preview와 내장 터미널을 함께 연 Claude Code Desktop 작업 화면](/LearnClaude/images/workspace-preview-terminal.1y8y7_kh35hod.png)
...
![Claude Code Desktop에서 프로젝트 파일 트리를 보는 화면](/LearnClaude/images/file-tree.3k8329aww8o_h.png)
...
![Diff 화면에서 변경된 파일과 줄을 보는 Claude Code Desktop 화면](/LearnClaude/images/diff-screen-overview.1k76994i54d44.png)
