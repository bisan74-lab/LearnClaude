...
![Routines 페이지에서 New routine의 Local·Cloud 선택](https://bisan74-lab.github.io/LearnClaude/images/routines-local-cloud.3jw_snl0o16ng.png)

### [Step 2: 프롬프트와 저장소, 스케줄 설정하기](#step-2-프롬프트와-저장소-스케줄-설정하기)

새 루틴 폼에서 이름, 프롬프트, 저장소를 채우고 트리거로 Schedule을 고릅니다.

![New routine 폼의 저장소·환경·모델·이름·Instructions·트리거](https://bisan74-lab.github.io/LearnClaude/images/new-routine-form.3fsncpt5h6j22.png)
...
![저장된 루틴 상세 화면과 Run now 버튼](https://bisan74-lab.github.io/LearnClaude/images/routine-detail-run-now.29z8m98ok93bf.png)
