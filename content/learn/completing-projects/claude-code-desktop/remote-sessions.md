...
![세션 실행 환경을 고르는 드롭다운 (Local·Cloud·Remote Control·SSH)](https://bisan74-lab.github.io/LearnClaude/images/cloud-session-picker.3x2f0ywh1eidf.png)
...
![PR이 생성되면 세션 하단에 나타나는 PR 상태 바](https://bisan74-lab.github.io/LearnClaude/images/pr-status-bar.0o4wsg4ibcy_s.png)
