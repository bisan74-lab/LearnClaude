...
![같은 폴더에서 두 Claude가 같은 파일을 동시에 수정해 충돌하는 상황](https://bisan74-lab.github.io/LearnClaude/images/dual-agent-collision.1x68b176c2g-b.png)
...
![Claude 세션 종료 시 등장하는 Keep/Remove 선택 프롬프트](https://bisan74-lab.github.io/LearnClaude/images/worktree-exit-prompt.36jx_nowtz1_8.png)
