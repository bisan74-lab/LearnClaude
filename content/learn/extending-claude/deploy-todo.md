...
![Claude가 push를 마친 뒤 내 GitHub 계정에 생긴 todo-tutorial 저장소](https://bisan74-lab.github.io/LearnClaude/images/github-my-repo.0xrcnh6p7mq8m.png)
...
![Vercel Sign Up 화면에서 Continue with GitHub를 고르는 위치](https://bisan74-lab.github.io/LearnClaude/images/vercel-signup.1so8vkqhtzusk.png)
...
![Vercel 대시보드의 Add New Project 버튼](https://bisan74-lab.github.io/LearnClaude/images/vercel-add-project.1-9szz-30tq3f.png)

① Search 박스에 저장소 이름을 입력해 방금 만든 저장소를 찾고, ② 옆의 Import 버튼을 클릭합니다.

![Vercel에서 todo-tutorial 저장소를 검색해 Import하는 화면](https://bisan74-lab.github.io/LearnClaude/images/vercel-import-repo.3b4vbg_fjwzqc.png)

다음 화면에서 Application Preset은 Next.js로 자동 감지됩니다. Todo는 외부 키 없이 브라우저에서 동작하므로 Environment Variables는 비워둔 채 ① Deploy 버튼을 클릭합니다.

![Vercel New Project 화면에서 Environment Variables를 비우고 Deploy를 누르는 위치](https://bisan74-lab.github.io/LearnClaude/images/vercel-deploy.10r-6jcpunp91.png)
...
![배포된 .vercel.app 주소에서 뜬 Todo 앱](https://bisan74-lab.github.io/LearnClaude/images/vercel-deployed-todo.1ct52hoj8vjz1.png)
