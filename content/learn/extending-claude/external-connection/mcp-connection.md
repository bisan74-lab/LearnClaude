...
![Claude in Chrome 상태 화면](/LearnClaude/images/claude-in-chrome-status.1rcb7a0kwgzt8.png)
...
![MCP 목록에 표시된 claude-in-chrome](/LearnClaude/images/claude-in-chrome-mcp-list.0q7zx_eut2vhd.png)
